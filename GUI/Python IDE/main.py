...
code_input.place(x=150, y=0, width=680, height=720)
...
Button(root, image=Open, bg='#323846', bd=0, command=open_file).place(x=10, y=30)
Button(root, image=Save, bg='#323846', bd=0, command=save).place(x=10, y=145)
Button(root, image=Run, bg='#323846', bd=0, command=run).place(x=10, y=260)
